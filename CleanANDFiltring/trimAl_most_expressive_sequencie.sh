...
do source/trimal -in $file -out best_$file -clusters 3 -noallgaps;
done
...
#grep -c ">" new_best_single_line_*SFTP[AD]* > abc ; # how many sequencies have in the trimmed file
#wc -l new_best_single_line_*SFTP[AD]* > def ;
#grep -c ">" single_line_*SFTP[AD]* > ghi;
#paste abc def ghi > jkl;
#sed 's/single_line_aligned_by_MAFFT_Ortho_SFTP/:/g' jkl | awk -F ":" '{print $2 '\t' $3 '\t'$6}' > mno
